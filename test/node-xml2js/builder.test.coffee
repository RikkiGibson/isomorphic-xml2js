...
module.exports =
  ...
  'test headless option': (test) ->
    expected = "<xml><MsgId>5850440872586764820</MsgId></xml>"
    opts =
      headless: true
    builder = new xml2js.Builder opts
    obj = {"xml":{"MsgId":["5850440872586764820"]}}
  ...
  'test allowSurrogateChars option': (test) ->
    expected = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><xml><MsgId>\uD83D\uDC33</MsgId></xml>'
    opts =
  ...
  'test does not error on non string values when checking for cdata': (test) ->
    expected = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><xml><MsgId>10</MsgId></xml>'
    opts = cdata: true
    builder = new xml2js.Builder opts
    obj = {"xml":{"MsgId":10}}
    actual = builder.buildObject obj
  ...
  'test does not error on array values when checking for cdata': (test) ->
    expected = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><xml><MsgId>10</MsgId><MsgId>12</MsgId></xml>'
    opts = cdata: true
    builder = new xml2js.Builder opts
    obj = {"xml":{"MsgId":[10, 12]}}
    actual = builder.buildObject obj
  ...
  'test building obj with array': (test) ->
    expected = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><root><MsgId>10</MsgId><MsgId2>12</MsgId2></root>'
    opts = cdata: true
    builder = new xml2js.Builder opts
